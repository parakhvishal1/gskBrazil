...
function showDatePicker(id) {
    ...
    return `
        <div class="flex calendar-picker">
            ...
            <img class="arrow-down" src="/gskBrazil/assets/images/svg/down.svg" />
        </div>
    `;
}
...
function showDatePickerWhite(date) {
    ...
    return `
        <div class="flex calendar-picker">
            <img class="picker" src="/gskBrazil/assets/images/svg/calendar-white.svg" />
            <input type='text' id='tbDate' placeholder='${date ? date : locale["labels"]["pickDate"]}' readonly="readonly"></input>
            <!-- <img class="arrow-down" src="/gskBrazil/assets/images/svg/down-white.svg" /> -->
        </div>
    `;
}
